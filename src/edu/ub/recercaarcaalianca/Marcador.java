...
public class Marcador {
    ...
    private void pintarCambra(Context ctx, Graphics2D g) {
        ...
        g.drawString("Nivell: " + Nivell + " - Cambra: " + cambra, 150, y + 15);
    }
    ...
    private void pintarDiamants(Context ctx, Graphics2D g) {
       ...
       if (arqueologa.getDiamantesEncontrados() == true){
           g.drawString("| Ha trobat tots els diamants? Sí |", 270, y +15);  
       }
       else {
           g.drawString("| Ha trobat tots els diamants? No |", 270, y +15);
       }
       g.drawString("Quins diamants? " + Arrays.toString(arqueologa.getDiamantes()), 460, y +15); 
    }
