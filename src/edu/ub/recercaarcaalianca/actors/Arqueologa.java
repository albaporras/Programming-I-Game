...
public class Arqueologa extends AbstractActor {
    ...
    private boolean arcaEncontrada;
    private boolean DiamantesEncontrados;
    ...
    public Arqueologa() {
        ...
        this.comprobar=new boolean [5];
        this.comprobar[0]=false;
        this.comprobar[1]=false;
        this.comprobar[2]=false;
        this.comprobar[3]=false;
        this.comprobar[4]=false;
        
        arcaEncontrada = false;
                arcaEncontrada = false;

	diamantes = new String[5];
		for (int k = 0; k < 5; k++) {
			diamantes [k] = "_";
                }	
    ...
    public void setArcaEncontrada (boolean arcaEncontrada){
        this.arcaEncontrada = arcaEncontrada;
        
    }
    
    public boolean getArcaEncontrada() {
        return arcaEncontrada;
    }
    ...
    public void setComprobar(int i, boolean valor){
        comprobar[i] = valor; 
        
    }
    
    public void setDiamantesEncontrados(boolean DiamantesEncontrados){
	this.DiamantesEncontrados = DiamantesEncontrados;
    }
    
    public boolean getDiamantesEncontrados(){
	
       if( DiamantesEncontrados = comprobar[0] == true && comprobar[1] == true && comprobar[2] == true && comprobar[3] == true && comprobar[4] == true){   
            return DiamantesEncontrados = true;
       }else{
           return false;
       }  
